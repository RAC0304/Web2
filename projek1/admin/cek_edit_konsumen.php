...
mysqli_query($koneksi, "UPDATE users SET nama='$nama', email='$email', jk='$jk', tgl_lahir='$tanggal_lahir', mobile='$no_handphone', updateAt=current_timestamp()) WHERE roleId='$userData[id_user]' AND id=$id_user");
